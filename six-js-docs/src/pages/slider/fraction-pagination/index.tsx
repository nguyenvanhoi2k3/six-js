...
const css = `.slide {
  ...
  sx-slider-pagination[effect="fraction"] {
    display: flex;
    gap: 0px;
  }
`;

export default function FractionPaginationDemo() {
  return (
    <div
      id="demo-fraction-pagination"
      style={{ marginBottom: "30vh", paddingTop: "2rem" }}
    >
      <h3 className="flex-center m-10">Fraction pagination</h3>
      <Tabs>
