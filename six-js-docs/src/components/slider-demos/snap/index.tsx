...
const html = `<sx-slider per-view="3" grab-cursor drag="free" snap gap="10">
  <sx-slider-track>
    <sx-slider-slide>
...
export default function SnapDemo() {
  return (
    <div id="demo-snap" style={{ marginBottom: "30vh", paddingTop: "2rem" }}>
      <h3 className="flex-center">Snap</h3>
      <div
        className="m-10"
        style={{ width: "fit-content", margin: "auto", fontSize: "14px" }}
      >
        Trôi tự do nhưng snap lại ở slide gần nhất
      </div>
      <Tabs>
        <TabItem value="demo" label="Demo" default>
          <sx-slider per-view="3" grab-cursor drag="free" snap gap="10">
            <sx-slider-track>
              <sx-slider-slide>
