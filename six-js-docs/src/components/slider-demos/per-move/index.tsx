...
const html = `<sx-slider per-view="3" per-move="3" gap="10">
  <sx-slider-track>
    <sx-slider-slide>
...
export default function PerMoveDemo() {
  return (
    <div id="demo-per-move" style={{ marginBottom: "30vh", paddingTop: "2rem" }}>
      <h3 className="flex-center m-10">Per move</h3>
      <Tabs>
        <TabItem value="demo" label="Demo" default>
          <sx-slider per-view="3" per-move="3" gap="10">
            <sx-slider-track>
              <sx-slider-slide>
                <div className="slide">Slide 1</div>
              </sx-slider-slide>
