...
const html = `<sx-slider per-view="3" loop gap="10">
  <sx-slider-track>
    <sx-slider-slide>
...
export default function LoopDemo() {
  return (
    <div id="demo-loop" style={{ marginBottom: "30vh", paddingTop: "2rem" }}>
      <h3 className="flex-center m-10">Loop</h3>
      <Tabs>
        <TabItem value="demo" label="Demo" default>
          <sx-slider per-view="3" loop gap="10">
            <sx-slider-track>
              <sx-slider-slide>
